    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=8, verbose_name='名称')),
                ('description', models.CharField(max_length=64, verbose_name='描述')),
                ('term', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_module.GameTerm', verbose_name='所属术语')),
            ],
            options={
                'verbose_name': '可用物品类型',
        ...
        migrations.AddField(
            ...
            name='term',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_module.GameTerm', verbose_name='所属术语'),
        ),
    ]
