...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('item_module', '0002_currency_packcontainer'),
        ('game_module', '0002_auto_20200218_0005'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PlayerMoney',
            fields=[
                ('currency_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='item_module.Currency')),
