    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='question_module.Question', verbose_name='题目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pack_item', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='player_module.HumanPackItem', verbose_name='装备')),
            ],
            options={
                'verbose_name': '人类装备槽项',
