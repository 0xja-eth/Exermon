...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('exermon_module', '0002_auto_20200822_0008'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='battle_module.BattleItemSlot', verbose_name='容器')),
                ('pack_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='player_module.ItemPackItem', verbose_name='道具背包项')),
            ],
            options={
                'verbose_name': '槽类容器项',
