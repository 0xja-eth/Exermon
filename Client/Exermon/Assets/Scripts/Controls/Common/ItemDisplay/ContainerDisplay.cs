...
namespace UI.Common.Controls.ItemDisplays {
    ...
    /// 物品容器显示
    /// </summary>
    public class ContainerDisplay<T> : GroupView<SelectableItemDisplay<T>>, IContainerDisplay<T> where T : class {
        ...
        /// <param name="item">物品</param>
        public void transferItem(ContainerDisplay<T> container, T item) {
        ...
        /// <param name="container">容器</param>
        /// <param name="item">物品</param>
        protected virtual void acceptTransfer(ContainerDisplay<T> container, T item) {
            addItem(item);
        }
